class mx.controls.TextArea extends mx.core.ScrollView
{
   ...
   function getLineOffsets(Void)
   {
      ...
      {
         _loc12_.push(_loc9_);
         _loc4_ = _loc15_[_loc11_];
         _loc5_.text = _loc4_;
         _loc13_ = Math.ceil(_loc5_.textWidth / _loc7_);
         _loc10_ = Math.floor(_loc4_.length / _loc13_);
   ...
   function keyDown(e)
   {
      ...
      if(_loc5_ == 34)
      {
         ...
         _loc2_ = Math.min(this.label.bottomScroll + 1,this.label.maxscroll);
         if(_loc2_ == this.label.maxscroll)
         {
            _loc4_ = this.label.length;
